...
if gpus:
    ...
    # Optional: nur GPU 0 freigeben
    # tf.config.set_visible_devices(gpus[0], 'GPU')
    print(">> Using GPU:", gpus)
else:
    print("!! Keine GPU erkannt – es wird auf CPU trainiert.")
...
def run_train(args):
    ...
    batch_size_val = 2  # number of val/test samples is 96
    ...
    # optimizer
    opt = Adam(learning_rate=args.base_lr, beta_1=0.9, beta_2=0.999, epsilon=1e-07, amsgrad=False)
